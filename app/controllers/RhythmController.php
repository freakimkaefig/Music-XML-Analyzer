...
/**
 * Controller to search rhythm patterns
 *
 * @package 	Controllers
 */
class RhythmController {
	...
	/**
	 * Search function to compare rhythm pattern to xml files
	 *
					...
					for($j = 0; $j < $countPartMeasureNote; $j++){
						...
						if((int)$n->voice == (int)$lastVoice){
							...
							if(!isset($n->rest) && !isset($n->chord)){
								...
								array_push(self::$xmlCounterArray, self::$counter);
